...
const Card = ({nameId, img, title, notify, countNotify}) => {
    ...
    return (
        ...
        <div className='text-black font-roboto mb-8'>
            ...
            <div onClick={ handleOpenCard } id={nameId} name={nameId} className='md:h-64 flex flex-col cursor-pointer justify-between relative -mt-11 bg-white rounded-lg shadow-md'>
